...
#define NFLX (1 + COMPONENTS + HAVE_ENERGY + (CR_FLUID != NO ? 1:0)) // NEW
...
void Flux      (double **, double **, double *, double **, double *, double *, int, int);  // NEW
...
Riemann_Solver HLLI_Solver; // NEW1
