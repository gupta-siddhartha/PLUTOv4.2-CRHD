...
//  NEW (since we don't know which scheme will work fine)
#define NC_VdP_TOTENG     1
#define NC_PdV_TOTENG     2  
#define NC_OS_PdV_TOTENG  3      
#define NC_DCR_TOTENG     4
#define NC_PdV            5

#ifndef CR_DIFFUSION      // NEW
...
#define PARABOLIC_FLUX (RESISTIVITY|THERMAL_CONDUCTION|VISCOSITY|CR_DIFFUSION) // NEW
...
#if CR_DIFFUSION != NO              // NEW
 #include "CR_Diffusion/crd.h"      /* Cosmic ray diffusion header file */  
#endif
