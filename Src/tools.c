 ...
 *********************************************************************** */
{
  ...
  state->presscr   = ARRAY_1D(NMAX_POINT, double);       // NEW
  state->crd_flux  = ARRAY_2D(NMAX_POINT, NVAR, double); // NEW
  state->u_riemann = ARRAY_2D(NMAX_POINT, NVAR, double); // NEW
...
/* -------------------------------------
      allocating memory for HLLI solver // NEW1
   ------------------------------------- */

  state->vM = ARRAY_2D(NMAX_POINT, NVAR, double);
  state->uM = ARRAY_2D(NMAX_POINT, NVAR, double);
  state->Dm = ARRAY_2D(NMAX_POINT, NVAR, double);
  state->Dp = ARRAY_2D(NMAX_POINT, NVAR, double);
