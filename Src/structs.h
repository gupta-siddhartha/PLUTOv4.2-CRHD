...
typedef struct DATA{
  ...
  double ****UDA; // User's Defined Arrary // NEW
...
typedef struct STATE_1D{
  ...
  double **crd_flux;  /**< NEW : Cosmic ray diffusion flux */
  ...
  double *presscr;  /**< NEW : Cosmic ray pressure */
  ...
  unsigned char *flag;
  double fill1, fill2;
  double **uM, **vM; /**< Defined for HLLI solver */ // NEW1
  double **Dm, **Dp;

  double **u_riemann; //NEW1 
